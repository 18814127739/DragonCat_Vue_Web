      ...
      <div class="right-pane">
        <el-tabs v-model="activeTab" type="border-card">
          <el-tab-pane label="登录" name="login">
            <el-form :model="loginInfo" :rules="loginRules" label-position="top">
              <el-form-item label="账号：" prop="account">
                <el-input size="medium" placeholder="用户名/手机号/邮箱" v-model="loginInfo.account"></el-input>
              </el-form-item>
              ...
              <el-form-item class="btn-item" v-loading="loginLoading">
          ...
          <el-tab-pane label="注册" name="register">
            <el-form :model="registerInfo" :rules="registerRules" label-position="top">
              <el-form-item label="用户名：" prop="userName">
                <el-input v-model="registerInfo.userName" maxlength="20" size="medium"></el-input>
              </el-form-item>
              <el-form-item label="手机号：" prop="phone">
                <el-input v-model="registerInfo.phone" maxlength="11" size="medium"></el-input>
              </el-form-item>
              <el-form-item label="邮箱：" prop="eMail">
                <el-input type="eMail" v-model="registerInfo.eMail" maxlength="40" size="medium"></el-input>
              </el-form-item>
              <el-form-item label="密码：" prop="password">
                <el-input
                  type="password"
              ...
              <el-form-item class="btn-item" v-loading="registerLoading">
